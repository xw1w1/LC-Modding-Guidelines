...
**Before reading this chapter, make sure you have already completed the [mod setup](https://github.com/xw1w1/LC-Modding-Guidelines/blob/main/en/LethalLevelLoader/2.%20Mod%20setup.md).**
## ExtendedLevel
...
- `Selectable Level` field is responsible for the selectable level script, we'll deal with this later.
...
There is no any strict limits about it's size, but you may look at it in game and see if it looks good.
...
`Risk Level` - the danger level of the planet. `A`, `B`, `C`, `D`, `S`, `S+`, `S++`, anything of your choice. 
